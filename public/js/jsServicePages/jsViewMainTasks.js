...
function shortA(){
    ...
    function letters_last_name_get_color_main(){
    
        var letters_class = document.querySelectorAll('.tasks .tasks-details-main .task .letters_to_center .letters')
        var clients_Last_Name = document.querySelectorAll('.tasks .tasks-details-main .task .summary-data .clientNameLastName span')

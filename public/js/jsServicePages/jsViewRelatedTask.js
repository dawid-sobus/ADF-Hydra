...
function shortA(){
    ...
    function letters_last_name_get_color_related(){
    
        var letters_class = document.querySelectorAll('.tasks .letters_to_center .letters')
        var clients_Last_Name = document.querySelector('.tasks .related-data-client-outside .related-client-Data1 .clientLastName span')
